...
const StepThreeCardResult = ({pros, cons, result, title, a}) => {    
                ...
                <div className="card-body">
                    ...
                    <div className="card-result__chart">               
                        <svg className="circle-chart" viewBox="0 0 35.63 35.63" width="96px" height="96px" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <circle className="circle-chart__circle" stroke={result > 0 ? "#cee7ea": "#fbdbd9" } strokeWidth="3" strokeDasharray={`${a}, 100`} strokeLinecap="round" fill="none" cx="17.91549431" cy="17.91549431" r="15.91549431" />
